...
Command: npx @threlte/gltf@3.0.0-next.10 ./static/models/spaceship.glb --transform --types
...
<script lang="ts">
	...
	const gltf = useGltf<GLTFResult>('models/spaceship-transformed.glb', {
		dracoLoader,
		ktx2Loader,
		meshoptDecoder
	});
	...
	{:then gltf}
		...
		>
			...
			<T.Mesh
				castShadow
				receiveShadow
				geometry={gltf.nodes.Cube001_RPanel003_RExtr_spaceship_racer_0
					.geometry}
				material={gltf.materials.spaceship_racer}
				position={[739.26, 0, 0]}
			/>
